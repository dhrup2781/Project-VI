...
<html lang="en">
	<head> 	
		...
		<link rel="stylesheet" type="text/css" href="../CSS/sabbath.css" /> 		
	</head>
    <body>
        <style>
            body {
				...
				<nav class="navbar navbar-inverse navbar-fixed-top top_menu" role="navigation">	
					...
					<div class="collapse navbar-collapse" id="myNavbar">
						<ul class="nav navbar-nav navbar-right s_menu">
							...
							<li><a href="../PHP/sabbath.php">Sabbath mode</a></li> 
		...
		<div id="page_wrap">
			<form action="sabbath.php" method="post">
				...
				<div id="elevatorButtons">
					<div id="extraButtons">
						<button type="submit" class="btn btn-secondary btn-lg"  id="sabbath" name="sabbath">SABBATH</button><br/><br/> 
					</div>
					<div id="stopButton">
						<button type="submit" class="btn btn-danger s btn-lg"  id="stop" name="stop">STOP</button><br/><br/><br/>
					</div>
				</div>
			</form>
		</div>
